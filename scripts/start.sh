...
ln -s /var/tmp/credentials/opendsademo/Books /opendsa
...
nohup bash -c "rake jobs:work >> /opendsa-lti/log/development.log 2>&1"
RAILS_ENV=${ENVIRONMENT} bundle exec thin start -p ${PORT} >> /var/log/opendsa-lti.log 2>&1
