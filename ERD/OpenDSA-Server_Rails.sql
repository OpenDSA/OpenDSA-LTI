...
-- Tue 17 May 2016 02:57:26 PM EDT
...
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_unicode_ci
COMMENT = '# Represents a university, college, school, or other organization that has courses.';
...
SHOW WARNINGS;
CREATE INDEX `fk_courses_users1_idx` ON `opendsa_lti`.`courses` (`creator_id` ASC);
...
SHOW WARNINGS;
CREATE UNIQUE INDEX `index_course_offering_users` ON `opendsa_lti`.`course_enrollments` (`user_id` ASC, `course_offering_id` ASC);
...
-- -----------------------------------------------------
-- Table `opendsa_lti`.`book_roles`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `opendsa_lti`.`book_roles` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `opendsa_lti`.`book_roles` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`))
ENGINE = InnoDB
COMMENT = 'Represent users roles with a book instance';

SHOW WARNINGS;
CREATE UNIQUE INDEX `name_UNIQUE` ON `opendsa_lti`.`book_roles` (`name` ASC);
...
CREATE TABLE IF NOT EXISTS `opendsa_lti`.`inst_book_owners` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `user_id` INT(11) NOT NULL,
  `book_role_id` INT(11) NOT NULL,
  `created_at` DATETIME NOT NULL,
  `updated_at` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_inst_book_owners_users`
    FOREIGN KEY (`user_id`)
    REFERENCES `opendsa_lti`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_inst_book_owners_book_roles`
    FOREIGN KEY (`book_role_id`)
    REFERENCES `opendsa_lti`.`book_roles` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = '# Represents a many-to-many relationship between users and book instances\n# Admins can clone book instance configuration and give permission to Instructors to modify and/or recompile it';

SHOW WARNINGS;
CREATE INDEX `fk_inst_book_owners_users_idx` ON `opendsa_lti`.`inst_book_owners` (`user_id` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_inst_book_owners_book_roles_idx` ON `opendsa_lti`.`inst_book_owners` (`book_role_id` ASC);
...
CREATE TABLE IF NOT EXISTS `opendsa_lti`.`inst_books` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `course_offering_id` INT(11) NOT NULL,
  `inst_book_owner_id` INT(11) NOT NULL,
  ...
  `updated_at` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_inst_books_course_offerings`
    FOREIGN KEY (`course_offering_id`)
    REFERENCES `opendsa_lti`.`course_offerings` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_inst_books_inst_book_owners`
    FOREIGN KEY (`inst_book_owner_id`)
    REFERENCES `opendsa_lti`.`inst_book_owners` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1
COMMENT = 'Represents a book Instance which essentially means a compiled book (generated files under /Books directory) \nand links to corresponding LMS chapters/modules/sections/exercises (all links stored as Ids). ';

SHOW WARNINGS;
CREATE INDEX `fk_inst_books_course_offerings_idx` ON `opendsa_lti`.`inst_books` (`course_offering_id` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_inst_books_inst_book_owners_idx` ON `opendsa_lti`.`inst_books` (`inst_book_owner_id` ASC);
...
CREATE TABLE IF NOT EXISTS `opendsa_lti`.`inst_chapters` (
  ...
  `updated_at` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_inst_chapters_inst_books`
...
SHOW WARNINGS;
CREATE INDEX `inst_books` ON `opendsa_lti`.`inst_chapters` (`inst_book_id` ASC);
...
CREATE TABLE IF NOT EXISTS `opendsa_lti`.`inst_chapter_modules` (
  ...
  `updated_at` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_inst_chapter_modules_inst_chapters`
    FOREIGN KEY (`inst_chapter_id`)
    REFERENCES `opendsa_lti`.`inst_chapters` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_inst_chapter_modules_inst_modules`
    FOREIGN KEY (`inst_module_id`)
    REFERENCES `opendsa_lti`.`modules` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = '# Represents a many-to-many relationship between inst_chapters and inst_modules,\n# capturing the notion of chapter-specific list of modules.';

SHOW WARNINGS;
CREATE INDEX `fk_inst_chapter_modules_inst_chapters_idx` ON `opendsa_lti`.`inst_chapter_modules` (`inst_chapter_id` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_inst_chapter_modules_inst_modules_idx` ON `opendsa_lti`.`inst_chapter_modules` (`inst_module_id` ASC);
...
CREATE TABLE IF NOT EXISTS `opendsa_lti`.`inst_sections` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `inst_module_id` INT(11) NOT NULL,
  `inst_chapter_module_id` INT(11) NOT NULL,
  `short_display_name` VARCHAR(50) NOT NULL,
  `name` LONGTEXT NOT NULL,
  `position` INT(11) NULL DEFAULT NULL,
  ...
  CONSTRAINT `fk_odsa_module_sections_odsa_modules1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_inst_sections_inst_chapter_modules1`
    FOREIGN KEY (`inst_chapter_module_id`)
...
SHOW WARNINGS;
CREATE INDEX `fk_inst_sections_modules_idx` ON `opendsa_lti`.`inst_sections` (`inst_module_id` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_inst_sections_inst_chapter_modules_idx` ON `opendsa_lti`.`inst_sections` (`inst_chapter_module_id` ASC);
...
SHOW WARNINGS;
CREATE INDEX `fk_odsa_student_extensions_inst_sections1_idx` ON `opendsa_lti`.`odsa_student_extensions` (`inst_section_id` ASC);
...
SHOW WARNINGS;
CREATE UNIQUE INDEX `url_UNIQUE` ON `opendsa_lti`.`lms_instance` (`url` ASC);
...
SHOW WARNINGS;
CREATE INDEX `fk_lms_access_users1_idx` ON `opendsa_lti`.`lms_access` (`user_id` ASC);
...
CREATE TABLE IF NOT EXISTS `opendsa_lti`.`inst_book_section_exercises` (
  ...
  `inst_book_id` INT(11) NOT NULL,
  `inst_section_id` INT(11) NOT NULL,
  `inst_exercise_id` INT(11) NOT NULL,
  `points` DECIMAL(5,2) NOT NULL,
  `created_at` DATETIME NOT NULL,
  `updated_at` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_inst_book_section_exercises_inst_books`
    FOREIGN KEY (`inst_book_id`)
    REFERENCES `opendsa_lti`.`inst_books` (`id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
  CONSTRAINT `fk_inst_book_section_exercises_inst_sections`
    FOREIGN KEY (`inst_section_id`)
    REFERENCES `opendsa_lti`.`inst_sections` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_inst_book_section_exercises_inst_exercises`
    FOREIGN KEY (`inst_exercise_id`)
...
SHOW WARNINGS;
CREATE INDEX `fk_inst_book_section_exercises_inst_books_idx` ON `opendsa_lti`.`inst_book_section_exercises` (`inst_book_id` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_inst_book_section_exercises_inst_sections_idx` ON `opendsa_lti`.`inst_book_section_exercises` (`inst_section_id` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_inst_book_section_exercises_inst_exercises_idx` ON `opendsa_lti`.`inst_book_section_exercises` (`inst_exercise_id` ASC);
...
CREATE TABLE IF NOT EXISTS `opendsa_lti`.`odsa_user_interactions` (
  ...
  `updated_at` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_odsa_user_interactions_inst_books`
    FOREIGN KEY (`inst_book_id`)
    REFERENCES `opendsa_lti`.`inst_books` (`id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
  CONSTRAINT `fk_odsa_user_interactions_users`
    FOREIGN KEY (`user_id`)
    REFERENCES `opendsa_lti`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_odsa_user_interactions_inst_sections`
    FOREIGN KEY (`inst_section_id`)
    REFERENCES `opendsa_lti`.`inst_sections` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_odsa_user_interactions_inst_book_section_exercises`
...
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1
COMMENT = 'Capture user click stream and other events';

SHOW WARNINGS;
CREATE INDEX `fk_odsa_user_interactions_inst_books_idx` ON `opendsa_lti`.`odsa_user_interactions` (`inst_book_id` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_odsa_user_interactions_users_idx` ON `opendsa_lti`.`odsa_user_interactions` (`user_id` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_odsa_user_interactions_inst_sections_idx` ON `opendsa_lti`.`odsa_user_interactions` (`inst_section_id` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_odsa_user_interactions_inst_book_section_exercises_idx` ON `opendsa_lti`.`odsa_user_interactions` (`inst_book_section_exercise_id` ASC);
...
SHOW WARNINGS;
CREATE INDEX `fk_opendsa_userdata_users1_idx` ON `opendsa_lti`.`odsa_book_progress` (`user_id` ASC);
...
CREATE TABLE IF NOT EXISTS `opendsa_lti`.`odsa_exercise_progress` (
  ...
  `updated_at` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_odsa_exercise_progress_users`
    FOREIGN KEY (`user_id`)
    REFERENCES `opendsa_lti`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_odsa_exercise_progress_inst_book_section_exercises`
    FOREIGN KEY (`inst_book_section_exercise_id`)
    REFERENCES `opendsa_lti`.`inst_book_section_exercises` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
SHOW WARNINGS;
CREATE INDEX `fk_odsa_exercise_progress_users_idx` ON `opendsa_lti`.`odsa_exercise_progress` (`user_id` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_odsa_exercise_progress_inst_book_section_exercises_idx` ON `opendsa_lti`.`odsa_exercise_progress` (`inst_book_section_exercise_id` ASC);
...
CREATE TABLE IF NOT EXISTS `opendsa_lti`.`odsa_exercise_attempts` (
  ...
  `updated_at` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_odsa_exercise_attempts_users`
    FOREIGN KEY (`user_id`)
    REFERENCES `opendsa_lti`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_odsa_exercise_attempts_inst_book_section_exercises`
    FOREIGN KEY (`inst_book_section_exercise_id`)
    REFERENCES `opendsa_lti`.`inst_book_section_exercises` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
SHOW WARNINGS;
CREATE INDEX `fk_odsa_exercise_attempts_users_idx` ON `opendsa_lti`.`odsa_exercise_attempts` (`user_id` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_odsa_exercise_attempts_inst_book_section_exercises_idx` ON `opendsa_lti`.`odsa_exercise_attempts` (`inst_book_section_exercise_id` ASC);

SHOW WARNINGS;

-- -----------------------------------------------------
-- Table `opendsa_lti`.`odsa_module_progress`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `opendsa_lti`.`odsa_module_progress` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `opendsa_lti`.`odsa_module_progress` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `user_id` INT(11) NOT NULL,
  `inst_book_id` INT(11) NOT NULL,
  `inst_module_id` INT(11) NOT NULL,
...
SHOW WARNINGS;
CREATE INDEX `opendsa_usermodule_752eb95b` ON `opendsa_lti`.`odsa_module_progress` (`inst_book_id` ASC);

SHOW WARNINGS;
CREATE INDEX `opendsa_usermodule_ac126a2` ON `opendsa_lti`.`odsa_module_progress` (`inst_module_id` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_opendsa_usermodule_users1_idx` ON `opendsa_lti`.`odsa_module_progress` (`user_id` ASC);
