$(function () {
  ...
  function initExTools(lookups) {
    ...
    //
    $selectize_students = $("#select-for-students").selectize({
      valueField: "id",
      labelField: "name",
      searchField: ["first_name", "last_name", "email"],
      sortField: [
    ...
    $("select#select-for-students.selectized").each(function () {
      var update = function (e) {
    ...
    //
    $selectize_modules = $("#select-for-modules").selectize({
      persist: false,
    ...
    $("select#select-for-modules.selectized").each(function () {
      var update = function (e) {
        var mod_id = $(this).val();
        if (mod_id) {
    ...
    //
    $selectize_students_exs = $("#select-for-students-exs").selectize({
      valueField: "key",
      labelField: "name",
      searchField: ["name"],
    ...
    $("select#select-for-students-exs.selectized").each(function () {
      var update = function (e) {
