  ...
  class InstBookSectionExercise < ActiveRecord::Base
    ...
    if ActiveRecord::VERSION::STRING < '4.0.0' || defined?(ProtectedAttributes)
      attr_accessible :inst_book_id, :points, :inst_section_id, :cnf_exercise_id, :created_at, :updated_at
    end
    ...
    has_many :odsa_user_interactions, :foreign_key => 'inst_book_section_exercises_id', :class_name => 'OdsaUserInteraction'
