...
class OdsaModuleProgress < ApplicationRecord
  ...
  def self.get_progress(user_id, inst_chapter_module_id, inst_book_id, lis_outcome_service_url = nil, lis_result_sourcedid = nil, lms_access_id = nil)
    ...
    if lis_outcome_service_url.present? && (module_progress.lis_outcome_service_url != lis_outcome_service_url || module_progress.lis_result_sourcedid != lis_result_sourcedid || module_progress.lms_access_id != lms_access_id)
      module_progress.update(lis_outcome_service_url: lis_outcome_service_url, lis_result_sourcedid: lis_result_sourcedid, lms_access_id: lms_access_id)
    end
